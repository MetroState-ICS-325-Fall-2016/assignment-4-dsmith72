...
<table>
    ...
    <tr><td>Pick one drink item:</td>
        <td><?= $form->select($GLOBALS['drinks'], ['name' => 'drinks']) ?></td>
    </tr>
    ...
    <tr><td>Enter e-mail address.</td>
        <td><?= $form->input('text', ['name' => 'email']) ?></td></tr>

    <tr><td align="center"><?= $form->input('submit', ['value' => 'Order']) ?></td>
        <td><?= $form->input('reset', ['value' => 'Reset']) ?></td></tr>
